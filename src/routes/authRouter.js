...
authRouter.endpoints = [
  ...
  },
  {
    ...
    example: `curl -X PUT localhost:3000/api/auth -d '{"email":"a@jwt.com", "password":"yougotme"}' -H 'Content-Type: application/json'`,
  ...
  },
  {
    ...
    example: `curl -X PUT localhost:3000/api/auth/1 -d '{"email":"a@jwt.com", "password":"yougotme"}' -H 'Content-Type: application/json' -H 'Authorization: Bearer tttttt'`,
...
authRouter.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    try {
      ...
      // If we get here and have a user, authentication succeeded
      const auth = await setAuth(user);
